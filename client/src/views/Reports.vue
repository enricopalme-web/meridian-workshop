...
export default {
  ...
  setup() {
    ...
    watch([selectedLocation], loadReports)
...
:global([data-theme="dark"]) .badge.success { background: #064e3b; color: #6ee7b7; }
:global([data-theme="dark"]) .badge.warning { background: #431407; color: #fdba74; }
:global([data-theme="dark"]) .badge.danger  { background: #450a0a; color: #fca5a5; }
...
:global([data-theme="dark"]) .reports .error {
  background: #450a0a;
  color: #fca5a5;
}
</style>
